      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 xl:gap-12 mb-12">
          <div className="md:col-span-1">
            <h2 className="text-2xl font-bold mb-4">SolarSmartLeads</h2>
            <p className="text-white text-opacity-80 mb-4">
              Guaranteed qualified solar leads for installation companies nationwide.
            </p>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-white text-opacity-80">
              ...
              <li><a href="#services" className="hover:text-white transition-colors">Appointment Setting</a></li>
              <li><a href="#services" className="hover:text-white transition-colors">Local Market Analysis</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-white text-opacity-80">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Lead Quality Guarantee</a></li>
        ...
        <div className="border-t border-white border-opacity-20 pt-8 mt-8 text-center">
          <p className="text-white text-opacity-70 text-sm">
            © {new Date().getFullYear()} SolarSmartLeads. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
